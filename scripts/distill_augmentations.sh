...
python distillation.py \
    ...
    --teacher-backbone-weights ../depth-anything-v2/saved_models/best_model_depth_v2_augmentation_2421854.pth \
    ...
    --distill-lambda 1.0 \
    --use-wandb \
    --experiment-name "depth_distill_augmentations_tgm_${SLURM_JOB_ID}"
